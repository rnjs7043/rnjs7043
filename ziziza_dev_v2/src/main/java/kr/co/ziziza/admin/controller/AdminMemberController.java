...
public class AdminMemberController {
	...
	public @ResponseBody String modify(AdminMemberVO vo) {
		...
		if(!password.equals("")) vo.setPassword(passwordEncoder.encode(vo.getPassword()));
	...
	/**
	 * Duplicate ID Proc	 	중복 체크
	 * @param		id			입력 아이디
	 * @return		Json
	 * @exception
	 */
	@RequestMapping(value = "checkId", method = RequestMethod.POST)
	public @ResponseBody String checkId(@RequestParam Map<String, Object> params) {
		int success = service.checkId(params);
		return String.valueOf(success);
	}//delete()
