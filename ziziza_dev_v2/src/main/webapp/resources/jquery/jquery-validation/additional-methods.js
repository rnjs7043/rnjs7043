...
$.validator.addMethod('minbytelength', function(value, element, params){
	var nMin = params;
...
$.validator.addMethod('bytelength', function(value, element, params){
	...
	var nMax = params.max;
	var nBytes = $.type(value) !== "string" ? 0 : value.getByteLength();
	return this.optional(element) || (nBytes === 0 || (nBytes >= nMin && nByte <= nMax))
});

$.validator.addMethod('bizId', function(value, element, params){
