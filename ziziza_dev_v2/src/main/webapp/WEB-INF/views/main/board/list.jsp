...
<body class="homepage">
   ...
   <div class="container">
   	...
   	<div  class="col-sm-8">
	   	<form action="/board/list" class="navbar-form navbar-right searchForm">
...
<div class="container" style="min-height:700px;">
	...
	<div class="row">
		<div class="col-sm6 navbar-right">
<!-- 			<a href="/board/write" class="btn ">글쓰기</a> -->
			<button id="btn_Write2" class="btn btn-outline-success">글쓰기</button>
		</div>
	</div>
	</c:if>
