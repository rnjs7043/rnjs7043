            ...
            <div class="row">
                <div class="portfolio-items">
                    ...
                    <div class="portfolio-item apps col-xs-12 col-sm-4 col-md-3 single-work">
                        ...
                        <a href="/event/detail?board_no=${vo.board_no}">
                        	<c:choose>
                        ...
                        <p class="text-center"><a href="/event/detail?board_no=${vo.board_no}"><c:out value="${vo.title}"  escapeXml="true"/></a></p>
                ...
                <div class="themeum-pagination">
					...
					<c:if test="${page.prevState}">
						<li><a class="prev page-numbers" href="/event/list?currentPage=${page.currentPage - 1}" data-page="${page.currentPage - 1}"><i class="fa fa-long-arrow-left" aria-hidden="true"></i></a></li>
					</c:if>
					<c:forEach begin="${page.startPage}" end="${page.endPage}" step="1" var="i">
						<c:choose>
							...
							<c:otherwise>
								<li><a class="page-numbers" href="/event/list?currentPage=${i}" data-page="${i}">${i}</a></li>
							</c:otherwise>
						</c:choose>
					</c:forEach>
					<c:if test="${page.nextState}">
						<li><a class="next page-numbers" href="/event/list?currentPage=${page.currentPage + 1}" data-page="${page.currentPage + 1}"><i class="fa fa-long-arrow-right" aria-hidden="true"></i></a></li>
					</c:if>
					</ul>
				</div>
            </div>
