...
<%--                             <input type="text" class="form-control" required="required" disabled="disabled"  value="${detailVO.title}"> --%>
                            <div style="min-height:100px; text-align: center"><h1>${detailVO.title}</h1></div>
<%--                             <input type="text" class="form-control" required="required" disabled="disabled"  value='<c:out value="${detailVO.title}"  escapeXml="true"/>'> --%>
                        </div>
                        
<!--                         <div class="form-group"> -->
<!--                             <label>작성자</label> -->
<%--                             <input type="text"  class="form-control" required="required" disabled="disabled" value="${detailVO.member_no}"> --%>
<%--                             <div style="min-height:200px;">${detailVO.member_no}</div> --%>
<!--                         </div> -->
                        <div class="form-group">
<!--                             <label>내용</label> -->
            ...
            <div class="col-sm-4 col-md-offset-8" style="min-height:200px;">
