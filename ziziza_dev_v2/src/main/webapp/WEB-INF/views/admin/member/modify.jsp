				...
				<div class="content">
					<form action='<c:url value="/admin/member/modify"/>' name="form" class="form" data-no='<c:out value="${param.no}"/>' method="post" enctype="multipart/form-data">
						<fieldset class="box">
							...
							<div class="fc">
								<label for="memberId">아이디</label><input type="text" name="memberId" id="memberId" maxlength="16" disabled/>
							</div>
						...
						<fieldset class="fOpt">
							<a href='<c:url value="/admin/member/delete"/>' class="dBtn btn danger fl">삭제</a>
							<a href='<c:url value="/tempPw"/>' class="pBtn btn waring fl">임시비밀번호발송</a>
