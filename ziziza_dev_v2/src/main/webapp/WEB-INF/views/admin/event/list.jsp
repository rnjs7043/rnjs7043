...
function putList(list){
	...
	if(list.length > 0){
		$.each(list, function(index, vo){
			var tr = temp.clone();
			var link = $('<a href="<c:url value='/admin/board/event/modify'/>?no=' + vo.boardNo + '">').text((vo.title).DecodeXMLEscapeChars());
			...
			<div class="contents">
				...
				<div class="content">
					...
					<div class="lOpt">
						...
						<p class="btnBox ar">
							<a href='<c:url value="/admin/board/event/regist"/>' class="rBtn btn md link">등록</a>
						</p>
					</div>
				</div>
			</div><!-- /.contents -->
