			  		...
			  		<div class="form-group">
			  			<div class="form-group col-md-8 col-md-offset-2">
							...
							<div class="collapse" id="agreeText1">
							 	<textarea class="form-control" cols="5" readonly="readonly">
제1조(목적)
			  		...
			  		<div class="form-group">
			  			<div class="form-group col-md-8 col-md-offset-2">			
							...
							<div class="collapse" id="agreeText2">
							 	<textarea class="form-control" readonly="readonly" cols="5" style="overflow: auto">
1. 개인정보 수집목적 및 이용목적
  							...
  							<div class="card card-body">
   								...
   								<div class="form-group">
	      							...
	      							<div class="form-group col-md-12">
    									<label for="exampleFormControlFile1">사업자 등록증</label>
